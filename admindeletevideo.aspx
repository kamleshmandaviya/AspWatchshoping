<%@ Page Language="C#" MasterPageFile="~/thired.master" AutoEventWireup="true" CodeFile="admindeletevideo.aspx.cs" Inherits="admindeletevideo1" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 750px" class="backgroundmidle scrollbar">
        ...
        <eo:MsgBox ID="MsgBox1" runat="server" AllowResize="True" 
            ...
            MinWidth="150" onbuttonclick="MsgBox1_ButtonClick" Width="320px">
            <headerstyleactive 
